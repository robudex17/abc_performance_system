...
exports.addAgentEmailResponseTime = async (req, res, next) => {
...
exports.fetchAgentEmailResponseTime = async (req, res, next) => {
    const errors = validationResult(req);
    if (!errors.isEmpty()) {
      return res.status(400).json({ errors: errors.array() });
    }
...
exports.updateAgentEmailResponseTime = async (req,res, io) => {
...
exports.deleteAgentEmailResponseTime = async (req, res, next) => {
